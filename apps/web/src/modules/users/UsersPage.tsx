...
const styles: Record<string, CSSProperties> = {
  ...
  kpiCard: { ...kpiCardBase, display: 'flex', alignItems: 'center', gap: 14, minHeight: 92 },
  kpiIcon: { width: 44, height: 44, borderRadius: 12, display: 'grid', placeItems: 'center', color: uiTheme.colors.primary, background: uiTheme.colors.primarySoft },
  ...
  card: { ...tableCardBase, borderRadius: uiTheme.radii.md, overflow: 'hidden' },
  ...
  tr: { borderBottom: `1px solid ${uiTheme.colors.surfaceSoft}` },
  ...
  actionButton: { ...secondaryButtonBase, minHeight: 34, padding: '0 10px', borderRadius: 9, fontSize: 12, display: 'inline-flex', alignItems: 'center', gap: 6, cursor: 'pointer' },
  smallButton: { ...secondaryButtonBase, minHeight: 32, padding: '0 10px', borderRadius: 8, fontSize: 12, cursor: 'pointer', width: 'fit-content' },
  dangerButton: { ...secondaryButtonBase, color: uiTheme.colors.danger, minHeight: 32, padding: '0 10px', borderRadius: 8, fontSize: 12, cursor: 'pointer' },
  ...
  modal: { ...surfaceCard, width: 'min(560px, 100%)', padding: 24, borderRadius: uiTheme.radii.md },
  ...
  secondaryButton: { ...secondaryButtonBase, height: 40, borderRadius: uiTheme.radii.sm, padding: '0 14px', cursor: 'pointer' },
  primaryButton: { ...primaryButtonBase, height: 40, borderRadius: uiTheme.radii.sm, padding: '0 16px', cursor: 'pointer' },
};
