...
const styles: Record<string, CSSProperties> = {
  ...
  filterButton: { ...secondaryButtonBase, minHeight: 36, padding: '0 14px', cursor: 'pointer', borderRadius: 14 },
  filterButtonActive: { background: uiTheme.colors.primary, color: '#fff', borderColor: uiTheme.colors.primary },
  card: { ...surfaceCard, overflow: 'hidden', borderRadius: 20 },
  ...
  inlineButton: { ...secondaryButtonBase, minHeight: 32, padding: '0 10px', cursor: 'pointer', fontSize: 12, borderRadius: 12 },
