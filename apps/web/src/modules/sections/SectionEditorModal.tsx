...
const DEFAULT_LOCATIONS = ['Madrid', 'Frankfurt', 'Virginia'] as const;
...
function getModeContent(mode: SectionEditorMode, hasSection: boolean) {
  if (mode === 'monitors') {
    return {
...
function getStatusLabel(status: MonitorStatus | MonitorViewStatus) {
  if (status === 'UP') {
    return 'Operativo';
  }
